...
export default function CourseManagement({ role = "admin" }) {
  ...
  const canManage = role === "admin" || role === "content-manager" || role === "instructor";
